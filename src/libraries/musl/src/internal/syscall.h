...
#ifndef __scc
#define __scc(X) ((_vos_syscallarg_t) (X))
typedef _vos_syscallarg_t syscall_arg_t;
#endif

hidden long __syscall_ret(unsigned long),
	__syscall_cp(_vos_syscallarg_t, _vos_syscallarg_t, _vos_syscallarg_t, _vos_syscallarg_t,
	             _vos_syscallarg_t, _vos_syscallarg_t, _vos_syscallarg_t);

#define __syscall0(n) _vos_syscall(n,0)
#define __syscall1(n,a) _vos_syscall(n,1,__scc(a))
#define __syscall2(n,a,b) _vos_syscall(n,2,__scc(a),__scc(b))
#define __syscall3(n,a,b,c) _vos_syscall(n,3,__scc(a),__scc(b),__scc(c))
#define __syscall4(n,a,b,c,d) _vos_syscall(n,4,__scc(a),__scc(b),__scc(c),__scc(d))
#define __syscall5(n,a,b,c,d,e) _vos_syscall(n,5,__scc(a),__scc(b),__scc(c),__scc(d),__scc(e))
#define __syscall6(n,a,b,c,d,e,f) _vos_syscall(n,6,__scc(a),__scc(b),__scc(c),__scc(d),__scc(e),__scc(f))
...
//#define __SYSCALL_DISP(b,...) _VOS_SYSCALL(b,__VA_ARGS__)
